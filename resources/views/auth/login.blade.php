    	...
    	<div class="row">
			<div class="col-md-6 col-md-offset-3">
				<div class="login-logo">
					<h2> <img src="{!! asset('photo/logo-square.png') !!}"></h2>		
				</div>
							...
							<div class="col-lg-12">
								...
								<input type="hidden" name="_token" value="{{ csrf_token() }}">
									<div class="form-group has-feedback">
										<input type="text" name="email" id="username" tabindex="1" class="form-control" placeholder="Email" autofocus value="{{ old('email') }}">
